/* FILE WAS OBTAINED FROM DIRECTSHOW .NET
 * (https://sourceforge.net/projects/directshownet/?source=typ_redirect) 
 * THIS IS NOT A PART OF THE ALGORITHMS 
 * AND IS NOT WRITEN BY THE AUTHORS WHO
 * HAVE WRITTEN THE REST OF THE PROGRAM
 */
